...
cRFC = 'LAN8507268IA'
cResponse= CancelationByCSD(cURL, cToken, cUUID, cCer, cKey, cRFC, cPasswordCsd)
? cResponse
MESSAGEBOX(cResponse)
```
...
cUUID = '5d42df44-0b9f-4bb6-8bf0-3622cb3b2543'
cRFC = 'LAN8507268IA'
cResponse= CancelationByPFX(cURL, cToken, cUUID, cPfx, cRFC, cPassword)
? cResponse
MESSAGEBOX(cResponse)
```
...
cLRFC = 'LSO1306189R5'
cToken = GetTokenValue(Authentication(cURL, cUser, cPassword))
Respuesta = SearchByLRFC(cURL, cToken, cLRFC)
? Respuesta 
MESSAGEBOX(Respuesta)
```
...
cUser = 'demo'
cPassword = '123456789'
cLCO_Cert = '00001000000304726808'
cToken = GetTokenValue(Authentication(cURL, cUser, cPassword))
Respuesta = SearchByNoCert(cURL, cToken, cLCO_Cert)
? Respuesta 
MESSAGEBOX(Respuesta)
```
...
xmlResponse = EstatusCFDI(cUrl, cRfcEmisor, cRfcReceptor, cTotal, cUUID)
? xmlResponse
